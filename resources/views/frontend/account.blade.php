                            ...
                            <div class="row align-items-end">
                                <div class="col-md-12">
                                    <div class="form-group">
					                    ...
					                    <img id="avatar" class="thumbnail" width="300px" src="{{asset('../storage/app/avatarClient/'.Auth::guard('clients')->user()->image)}}" >
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered display" id="table" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    @if($bill->client_id == Auth::guard('clients')->user()->id)
                                    <tr>
                                        <td>{{$bill->id}}</td>
